...
import { Oembed } from "../../../components/Oembed/index"

<Meta title="2 Pattern Library/4 Slices/Oembed" component={Oembed} />
...
<Preview>
    <Story name="Oembed Twitter">
        <div style={{padding: "20px", maxWidth: "700px"}}>
            <Oembed oembedObject={{
                html: "<blockquote class=\"twitter-tweet\"><p lang=\"en\" dir=\"ltr\">🇯🇵 Claim your BFI Player subscription free trial today and watch landmark classic and cult films on-demand in our major new season <a href=\"https://twitter.com/hashtag/BFIJapan?src=hash&amp;ref_src=twsrc%5Etfw\">#BFIJapan</a>. No commitment. Cancel at any time.</p>&mdash; BFI (at 🏠) (@BFI) <a href=\"https://twitter.com/BFI/status/1260240790795816961?ref_src=twsrc%5Etfw\">May 12, 2020</a></blockquote> <script async src=\"https://platform.twitter.com/widgets.js\" charset=\"utf-8\"></script>"
            }} />
        </div>
    </Story>
</Preview>
