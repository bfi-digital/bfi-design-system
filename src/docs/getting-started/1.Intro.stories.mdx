...
4. [The Pattern Library](/?path=/story/2-pattern-library-0-pattern-library-guide--page) - is a great place to start to explain the Pattern Library which has examples and definitions of all avaliable components within the design system.
