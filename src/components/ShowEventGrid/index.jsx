...
export const ShowEventGrid = ({
    ...
    return(
        <ConditionalWrapper
            ...
            wrapper={children => <Scroller noOfChildren={events.length} classes="show_event_block">{children}</Scroller>}
            wrapper2={children => <Events className="show_event_block">{children}</Events>}
        >
            {events.map(event =>
                <EventCard 
